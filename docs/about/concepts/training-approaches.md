...
With this context on training approaches, the next step is to understand what an environment is and the {ref}`core-components` that make up a training environment in NeMo Gym.
